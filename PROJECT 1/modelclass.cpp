...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	for (i = 0; i < m_vertexCount; i+=3) //Save tanget for normal
	{
		DirectX::SimpleMath::Vector3 vertex1 = vertices[i].position;
		DirectX::SimpleMath::Vector3 vertex2 = vertices[i + 1].position;
		DirectX::SimpleMath::Vector3 vertex3 = vertices[i + 2].position;

		DirectX::SimpleMath::Vector2 texCoord1 = vertices[i].texture;
		DirectX::SimpleMath::Vector2 texCoord2 = vertices[i + 1].texture;
		DirectX::SimpleMath::Vector2 texCoord3 = vertices[i + 2].texture;

		DirectX::SimpleMath::Vector3 deltaPos1 = vertex2 - vertex1;
		DirectX::SimpleMath::Vector3 deltaPos2 = vertex3 - vertex1;

		DirectX::SimpleMath::Vector3 deltaUV1 = texCoord2 - texCoord1;
		DirectX::SimpleMath::Vector3 deltaUV2 = texCoord3 - texCoord1;
