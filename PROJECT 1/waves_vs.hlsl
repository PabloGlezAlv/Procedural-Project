...
OutputType main(InputType input)
{
    ...
    //Licensed under the Apache License, Version 2.0 (the"License"); you may not use this file exceptin
    //compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
    
    //Adaptation from: https://github.com/Imperat/DirectX-CourseWork-2016/blob/master/Shader.fx
    
    //__author__ = 'leliykin@gmail.com (MichaelLelyakin)'
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        float2 X = X0 - K * amplitude * sin(dot(K, X0) - frequency * time * speed);
        float y = amplitude * cos(dot(K, X0) - frequency * time * speed);
        s_X += X[0] / u - 0.5f;
        s_Z += X[1] / v - 0.5f;
        s_Y += y;
    }
